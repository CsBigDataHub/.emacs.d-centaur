;; init-org-table-wrap-functions.el --- Initialize org configurations.	-*- lexical-binding: t -*-
;;
;;https://github.com/CsBigDataHub/org-table-wrap-functions
...
(provide 'init-org-table-wrap-functions)
